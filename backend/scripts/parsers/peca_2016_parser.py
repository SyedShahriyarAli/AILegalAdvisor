"""
Parser for Prevention of Electronic Crimes Act, 2016
...
def detect_sections_and_chapters(pages_data: List[Dict]) -> List[Dict]:
    ...
    for page_data in pages_data:
        ...
        for i, line in enumerate(lines):
            ...
            # A simple heuristic: if it's before page 6, it might be CONTENTS.
            # PECA 2016 Act text starts on page 6.
            if page_num < 6:
                continue
...
def parse_peca_act(pdf_path: str) -> Dict:
    ...
    output = {
        "document": {
            "title": "The Prevention of Electronic Crimes Act, 2016",
            "year": 2016,
            "source_file": "PECA Act, 2016.pdf",
...
if __name__ == "__main__":
    ...
    pdf_path = os.path.join(script_dir, "../../data/pdfs/PECA-2016.pdf")

    if not os.path.exists(pdf_path):
        print(f"Error: PDF file not found at {pdf_path}")
        sys.exit(1)

    print("Starting PECA Act 2016 parsing...")
    result = parse_peca_act(pdf_path)

    output_path = os.path.join(script_dir, "../../data/jsons/peca-act-2016.json")
